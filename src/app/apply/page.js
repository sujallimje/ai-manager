                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between border-b border-gray-200 pb-2">
                      ...
                      <span className="font-medium text-gray-800 capitalize">
                        {loanAnswers.loanType} Loan
                      </span>
                    </div>
                    <div className="flex justify-between border-b border-gray-200 pb-2">
                      <span className="text-gray-600">Purpose:</span>
                      <span className="font-medium text-gray-800">
                        {loanAnswers.purpose || "Not specified"}
                      </span>
                    </div>
                    <div className="flex justify-between border-b border-gray-200 pb-2">
                    ...
                    <div className="flex justify-between border-b border-gray-200 pb-2">
                      ...
                      <span className="font-medium text-gray-800">
                        {loanAnswers.tenure || "Not specified"}
                      </span>
                    </div>
                    <div className="flex justify-between border-b border-gray-200 pb-2">
                      ...
                      <span className="font-medium text-gray-800">
                        ₹
                        {(extractedData.income?.monthlyIncome || "0").replace(
                          /[^0-9.]/g,
                          ""
                        )}
                      </span>
                  ...
                  <div>
                    ...
                    <div className="bg-green-50 p-6 rounded-lg mb-6 border border-green-200">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-gray-700">
                          <strong>Reason for Approval:</strong> Met all
                          eligibility criteria including income requirements and
                  ...
                  <div>
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-600">
                        We're unable to approve your loan application at this
                        time.
                      </p>
                    </div>
                    ...
                    <div className="bg-red-50 p-6 rounded-lg mb-6 border border-red-200">
                      ...
                      <ul className="list-disc pl-6 space-y-2">
                        <li className="text-gray-700">
                          ...
                          {extractedData.income?.monthlyIncome
                            ? (
                                Number(loanAmount) /
                                parseFloat(
                                  extractedData.income.monthlyIncome.replace(
                                    /[^0-9.]/g,
                                    ""
                                  )
                                )
                            ...
                            : "N/A"}
                          x) exceeds maximum allowed limit (10x)
                        </li>
                        <li className="text-gray-700">
                          {Object.keys(uploadedDocuments).length < 3
